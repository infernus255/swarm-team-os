...
1. **Memoria Global (`.swarm_template/.swarn/memory/SHARED_FOUNDATIONS.md`):** Lecciones aprendidas agnósticas (ej. manejo de encoding en Windows, reglas de concurrencia).
